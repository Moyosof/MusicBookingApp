...
public static partial class Errors
{
    public static class User
    {
        ...
        public static Error FailedToCreateRole => Error.Validation(
            code: "User.FailedToCreateRole",
            description: "Could not create role for user. Please check again later.");
    }
}